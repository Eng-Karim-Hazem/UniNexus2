...
class _SecurityIdScreenState extends State<SecurityIdScreen> {
  ...
  void initState() {
    ...
    // Automatically refresh the obfuscated token bytes every 30 seconds to keep timestamp valid
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      ShaderMask(
                                        ...
                                        child: QrImageView(
                                          // Upgraded from raw plain text qrData to the dynamic encrypted payload
