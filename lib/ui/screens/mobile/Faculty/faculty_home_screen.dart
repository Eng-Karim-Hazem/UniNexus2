...
class _FacultyHomeScreenState extends State<FacultyHomeScreen> {
  ...
  Widget _buildActionButtons(double sw, double sh) {
    return Row(
      children: [
        Expanded(child: _buildActionCard("Send Notices", 'assets/icons/Alarm_1.png', () => Navigator.push(context, MaterialPageRoute(builder: (context) => const SendNoticeScreen())), sh)),
